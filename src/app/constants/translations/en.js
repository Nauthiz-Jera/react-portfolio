export default {
  portfolio: {
    ...
    skill: {
      ...
      description:
        "My professional strengths lay in JavaScript development, in both front-end and back-end development. I'm adapt in Angular and React, two of the biggest MVC/Flux architectural frameworks/libraries. I also have background in mySql and knowledge in Express, Mongoose, and MongoDB.",
      knowledge: 'Knowledge',
      bulletGroupOne: [
        'Angular Framework',
        'React Library',
    ...
    experience: {
      afs: {
        ...
        description:
          'Worked on an internal web application for the U.S. Postal service, creating reports using the latest visualization libraries and web application framework.',
      },
      issi: {
        title: 'ISSI Software',
      ...
      donor: {
        ...
        position: 'Full-Stack Developer',
        description:
          'Developed, maintained, and integrated APIs with our web application for internal use as well as client use.',
      },
      fundopolis: {
        title: 'Fundopolis',
