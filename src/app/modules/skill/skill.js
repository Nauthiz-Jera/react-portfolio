...
const SkillContent = styled.div`
  ...
  width: 50%;
`;
const SkillHeader = styled.h1`font-weight: ${FONT_WEIGHT.NORMAL};`;
...
const SkillDescription = styled.div`
  ...
  color: ${COLORS.GREY.MYSTIQUE};
`;
const KnowledgeContainer = styled.div`margin: ${MARGIN.NORMAL};`;
const KnowledgeTitle = styled.h1`font-weight: ${FONT_WEIGHT.NORMAL};`;
  ...
  <ScrollableAnchor id={EN.portfolio.links.skill}>
    <SkillsContainer>
      ...
      <SkillContentContainer>
        <SkillContent>
          <SkillHeader>{EN.portfolio.skill.header}</SkillHeader>
          <SkillQuote>{EN.portfolio.skill.quote}</SkillQuote>
          <SkillDescription>{EN.portfolio.skill.description}</SkillDescription>
        </SkillContent>
        <Chart chartId={SKILL_BAR_CHART.chartId} config={SKILL_BAR_CHART.config} />
      </SkillContentContainer>
      <KnowledgeContainer>
        <KnowledgeTitle>{EN.portfolio.skill.knowledge}</KnowledgeTitle>
        <BulletsContainer>
